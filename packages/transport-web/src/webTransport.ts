import type { ApiTransport, CallCommand, DeleteCommand, InsertCommand, SelectQuery, UpdateCommand } from "@grimo/metadata"

/** Passes queries to a server over HTTP+JSON. */
